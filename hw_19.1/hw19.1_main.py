        ...
        <main class="row">
            <div class="row text-center">
                ...
                <div class="col-4">
                    <form>
                        ...
                        <div class="mb-3 rounded-3 shadow-sm">
                            <input name='email' type="email" placeholder="Email" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp">
                        </div>
            ...
            <div class="container px-4 py-5" id="hanging-icons">
                ...
                <p class="d-inline-flex gap-1">
                    ...
                    <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample3" role="button" aria-expanded="false" aria-controls="multiCollapseExample3">Какая гарантия?</a>
